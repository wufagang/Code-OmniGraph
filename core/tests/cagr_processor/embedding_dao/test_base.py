...
from cagr_processor.embedding_dao.base import BaseVectorDatabase, retry_on_failure
from cagr_processor.embedding_dao.models import VectorData, DistanceMetric, IndexType
...
class MockBaseVectorDatabase(BaseVectorDatabase):
    ...
    def get_collection_info(self, collection_name):
        from cagr_processor.embedding_dao.models import CollectionInfo
    ...
    def check_collection_limit(self, collection_name):
        from cagr_processor.embedding_dao.models import CollectionLimit
...
class TestBaseVectorDatabase:
    ...
    def test_update_collection_cache(self):
        """测试更新集合缓存"""
        from cagr_processor.embedding_dao.models import CollectionInfo, DistanceMetric
